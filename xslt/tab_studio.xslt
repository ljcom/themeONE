...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    ...
    <section class="content-header visible-phone">
      <h1 data-target="#header" id="header_title">
              ...
              <xsl:for-each select="sqroot/body/bodyContent/form/formPages/formPage[@pageNo&lt;10]">
                <li draggable="true">
                  <xsl:attribute name="class">
                    <xsl:if test="@pageNo=1">active</xsl:if> drag-tab
                  </xsl:attribute>
                  
                  <a href="#tab_{@pageNo}" data-toggle="tab" style="display:inline-block"
                  ...
                  <div class="btn-group btn-group-sm studio-tab" role="group" aria-label="Basic example">
  ...
  <xsl:template match="formPages/formPage[@pageNo&lt;10]">
    <div id="tab_{@pageNo}">
      ...
      <section class="content">
        ...
        <!-- button view header -->
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 visible-phone" style="margin-bottom:50px;margin-top:5px;">
            <div style="text-align:left">
              <xsl:choose>
                ...
                <xsl:when test="(/sqroot/body/bodyContent/form/info/GUID/.) = '00000000-0000-0000-0000-000000000000'
				  ...
				  onclick="{$lowerCode}_save(20)">
                    <xsl:value-of select="/sqroot/body/bodyContent/form/info/btnsavecaption"/>
                  </button>&#160;
  ...
  <xsl:include href="_elements_studio.xslt" />

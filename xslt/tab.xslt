...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
  ...
  <xsl:template match="/">
    ...
    sideShowTab('<xsl:value-of select="/sqroot/header/info/title"/>', '<xsl:value-of select="/sqroot/header/info/user/userName"/>', '<xsl:value-of select="sqroot/body/bodyContent/form/info/code"/>');
